...
class Action:
    ...
    def is_unified(self, state: State) -> bool:
        ...
        """
        return not self.add_list.isdisjoint(state.positive_literals)
    ...
    def is_conflicting(self, state: State) -> bool:
        ...
        """
        return not self.delete_list.isdisjoint(state.positive_literals)
    ...
    def is_relevant(self, state: State) -> bool:
        ...
        return not self.add_list.isdisjoint(
            state.positive_literals
        ) and self.delete_list.isdisjoint(state.positive_literals)
